...
Built with Flask, Groq LLM, Docling, and PostgreSQL/SQLite. Deployable on Render or Vercel.
...
| Database | PostgreSQL (Render) / SQLite (Vercel local) |
...
`app.py` with PostgreSQL. Set environment variables in Render dashboard.
